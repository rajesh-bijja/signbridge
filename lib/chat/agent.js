...
// or when the iteration cap (llm.maxToolIterations) is hit. Tokens and tool-call
// status are streamed out through an injected emitter (Socket.IO in production).
...
async function runTurn(opts) {
    ...
    let maxIterations = llmClient.getMaxToolIterations();
